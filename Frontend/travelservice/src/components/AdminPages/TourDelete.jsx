...
const TourDelete = () => {
    ...
    useEffect(() => {
        fetch(`https://localhost:7026/api/admin/tour/delete/${tourid}`, {
            method: 'GET',
            headers: {
    ...
    return (
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content" style={{margin: 20}}>
                <main>
                    <Link to={`/admin/tour`}><button className="back-btn">Quay trở lại</button></Link>
                    ...
                    <div className="info-row">
                        <span className="info-label">Giá Cả:</span>
                        <span className="info-value">{tour.price}</span>
                    </div>
                    <div className="info-row">
