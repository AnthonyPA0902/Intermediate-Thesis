...
const AdminTourDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://localhost:7026/api/admin/tourdetails?page=${currentPage}&pageSize=6`, {
            method: 'GET',
            headers: {
                    ...
                    <div className="container mt-4">
                        <div className="row mb-3">
                            ...
                            <h1>QUẢN LÝ CHI TIẾT TOUR</h1>
                                <a href="/admin/tourdetails/create"><button type="button">THÊM MỚI</button></a>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col">
                                <table className="table table-bordered">    
                                    ...
                                    {tourDetails.map((t, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{t.end_date}</td>
                                            <td>{t.transport}</td>
                                            <td>{t.start_destination}</td>
                                            <td>{t.tour_id}</td>
                                            <td>
                                                <Link to={`/admin/tourdetails/edit?id=${t.id}`}><img src='/admin_assets/assets/img/edit-icon.png' alt="icon button"></img></Link>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <Link to={`/admin/tourdetails/delete?id=${t.id}`}><img src='/admin_assets/assets/img/delete-icon.png' alt="icon button"></img></Link>
                                            </td>
                                        </tr>
                                    ))}
                                    </tbody>
