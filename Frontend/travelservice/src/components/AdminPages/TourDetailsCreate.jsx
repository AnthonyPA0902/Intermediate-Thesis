...
const TourDetailsCreate = () => {
    ...
    const fetchTours = async () => {
        try {
            const response = await fetch('https://localhost:7026/api/admin/tourdetails/create', {
                    method: 'GET',
                    headers: {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    console.log("Create Tour Details Successful");
                } else {
                    console.error("Create Tour Details Failed");
                }
            } catch (error) {
                ...
                <div id="layoutSidenav_content">
                    <main>
                        ...
                        <form onSubmit={handleSubmit} className="create-employee-form">
                            <h2 className="form-title">Tạo Chi Tiết Tour Của Bạn</h2>
...
export default TourDetailsCreate;
