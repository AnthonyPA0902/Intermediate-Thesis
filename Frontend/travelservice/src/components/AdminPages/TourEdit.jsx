...
const TourEdit = () => {
    ...
    const fetchCategories = async () => {
        try {
            const response = await fetch('https://localhost:7026/api/admin/tour/edit', {
                    method: 'GET',
                    headers: {
    ...
    useEffect(() => {
        const fetchTourData = async () => {
            try {
                const response = await fetch(`https://localhost:7026/api/admin/tour/edit/${tourid}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                    ...
                    <main>
                        ...
                        <form onSubmit={handleSubmit} className="create-employee-form">
                            ...
                            <div className="form-group">
                                ...
                                <input type="tẽt" id="picture" name="picture" value={formData.picture} onChange={handleChange} />
